        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="text-center">
            ...
            <ol className="text-start text-lg text-gray-600 space-y-4">
              <li>Step 1: Open Taxi Sanchalak Application. In home screen at the bottom right click on Profile.</li>
              ...
              <li>Step 5: Complete your payment and do not close the application or click back button while making the payment. Once everything is completed you will be landed back to Taxi Sanchalak application.</li>
