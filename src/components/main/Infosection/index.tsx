  ...
  return (
    <>
      ...
      <section className="w-full mx-auto px-4 py-16 space-y-8 bg-white">
        ...
        <h2 className="text-base md:text-xl lg:text-2xl text-center font-semibold text-[#084200] leading-relaxed">
          Judein Hamare Saath aur Badayein Apna Vyapar
        </h2>
      </section>

      {/* Marketplace Section */}
      <section className="w-full mx-auto px-4 py-8 md:px-12 md:py-16  space-y-8 md:space-y-12 text-white">
      ...
      <section className="w-full mx-auto px-4 py-8 md:px-12 md:py-16 space-y-8 md:space-y-12 bg-white text-[#084200]">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center justify-center">
          <div className="space-y-6 text-center md:text-left px-6">
            <h3 className="text-base md:text-lg lg:text-xl font-bold ">
